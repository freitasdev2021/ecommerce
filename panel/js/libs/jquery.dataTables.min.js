...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primeiro",sLast:"Ultimo",sNext:"Proximo",sPrevious:"Anterior"},sEmptyTable:"Sem dados na tabela",sInfo:"Exibindo _START_ ate _END_ de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 ate 0 de 0 registros",sInfoFiltered:"(filtrando de _MAX_ registros totais)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"_MENU_ Itens por página",sLoadingRecords:"Lendo...",sProcessing:"Processando...",sSearch:"Pesquisar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Não foram encontrados resultados"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
